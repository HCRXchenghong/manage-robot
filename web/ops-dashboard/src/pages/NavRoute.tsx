// 循迹导航：给某车设置多个路点（可定时），从哪个点到哪个点，一键下发；
  ...
  return (
    <div style={{ padding: 16, overflow: "auto", height: "100%" }}>
      ...
      <div className="row" style={{ gap: 12, alignItems: "flex-start" }}>
        <div className="panel" style={{ width: 460, padding: 14 }}>
          <div className="panel-title">新建循迹任务</div>
          ...
          <div className="row" style={{ marginBottom: 8 }}>
            <span className="muted" style={{ width: 60 }}>任务名</span>
            <input
              className="input" value={name} placeholder="留空自动生成（起点→终点）"
        ...
        <div className="panel" style={{ flex: 1, padding: 14, minWidth: 380 }}>
          ...
          <table className="table">
            ...
            <tbody>
              {routes.length === 0 && (
                <tr><td colSpan={7} className="muted" style={{ textAlign: "center", padding: 18 }}>暂无任务</td></tr>
              )}
              {routes.map((rt) => (
                <tr key={rt.id}>
                  <td>
